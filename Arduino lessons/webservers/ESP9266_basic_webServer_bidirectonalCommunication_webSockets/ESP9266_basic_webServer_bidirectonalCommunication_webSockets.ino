...
void loop() {
  ...
  // Generate a random number between 0 and 100 every 1000 milli seconds
...
String processor(const String& var) {
  ...
  if(var == "BUTTONPLACEHOLDER"){
    ...
    buttons+= "<h2>Output - GPIO 2 - State <span id=\"outputState\"></span></h2><label class=\"switch\"><input type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"output\" " + outputStateValue + "><span class=\"slider\"></span></label>";
    return buttons;
  }
  return String();
}
